function contactSubmit() {
	...
	if (question == "" || name == "" || email == "") {
		...
		$.ajax({
			'type': 'POST',
			'url': `https://script.google.com/macros/s/1MnhaM_2JacQ_UR0HSmDCktk8T9_eFh6eSLj2ApF-VLJx2tAPIE1HXKMM/exec?function=logInfo=${name}&email=${email}&questions=${question}`,
			crossDomain: true,
			contentType: false,
